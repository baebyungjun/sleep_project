...
def main(n_class, length, N_sleep, ground_truth, prediction):
    ...
    if os.path.isfile('./ground_truth.pc'):
        print('DataFrame에서 값을 매칭하여 저장된 파일을 불러옵니다.')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt', type=str, default='./data/thumos14_test_groundtruth.csv')
    parser.add_argument('--pred', type=str, default='./data/pred_dump.pc')
    #parser.add_argument('--none_sleep', type=list, default=[0])
    ...
    all_class = list(set(gt['label213123_idx']))
